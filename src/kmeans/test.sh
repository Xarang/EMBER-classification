...
make
./kmeans 2 20 1.0 2351 900000 ../../ember/Xtrain.dat out.dat 1>"$KMEANS_OUTPUT_FILE"

echo "[KMEANS] outputted kmeans logs in $KMEANS_OUTPUT_FILE"
cat "$KMEANS_OUTPUT_FILE"

python3 ./accuracy/classification_eval.py out.dat ../../ember/Ytrain.dat 1>"$ACCURACY_OUTPUT_FILE"
